...
{
	/** @deprecated use pendinglink.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __pendinglink;
	private final deeplink.proxies.PendingLink pendinglink;

	public ExecuteDeeplink(
		IContext context,
		IMendixObject _pendinglink
	)
	{
		super(context);
		this.__pendinglink = _pendinglink;
		this.pendinglink = _pendinglink == null ? null : deeplink.proxies.PendingLink.initialize(getContext(), _pendinglink);
	}
